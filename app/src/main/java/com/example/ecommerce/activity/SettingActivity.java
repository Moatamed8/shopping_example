...
public class SettingActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(SettingActivity.this,R.color.colord2));


        storageProfilePrictureRef = FirebaseStorage.getInstance().getReference().child("Profile pictures");

        securitylink =  findViewById(R.id.security_question);
        ...
        securitylink.setOnClickListener(new View.OnClickListener() {
            @Override
